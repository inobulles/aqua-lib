...
int font_draw(font_t font, const char* string, float red, float green, float blue, float alpha, int64_t wrap_width, int64_t wrap_height, uint8_t** bitmap_reference, uint64_t* width_reference, uint64_t* height_reference) {
